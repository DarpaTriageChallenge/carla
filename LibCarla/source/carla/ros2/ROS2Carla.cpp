...
void ROS2Carla::AddActorRosName(void *actor, std::string ros_name) {
  _actor_ros_name.insert({actor, ros_name});
}

void ROS2Carla::AddActorParentRosName(void *actor, void* parent) {
...
void ROS2Carla::RemoveActorRosName(void *actor) {
...
void ROS2Carla::UpdateActorRosName(void *actor, std::string ros_name) {
...
std::string ROS2Carla::GetActorRosName(void *actor) {
  auto it = _actor_ros_name.find(actor);
  if (it != _actor_ros_name.end()) {
    return it->second;
  } else {
...
std::string ROS2Carla::GetActorParentRosName(void *actor) {
  auto it = _actor_parent_ros_name.find(actor);
  if (it != _actor_parent_ros_name.end())
  {
