...
#include "CarlaVehicleSubscriberListener.h"
#include <iostream>
...
namespace ros2 {
  ...
  using erc = eprosima::fastrtps::types::ReturnCode_t;
    ...
    class CarlaVehicleSubscriberListenerImpl : public efd::DataReaderListener {
      public:
    ...
    void CarlaVehicleSubscriberListenerImpl::on_subscription_matched(efd::DataReader* reader, const efd::SubscriptionMatchedStatus& info)
    {
    ...
    void CarlaVehicleSubscriberListenerImpl::on_data_available(efd::DataReader* reader)
    {
      efd::SampleInfo info;
    ...
    void CarlaVehicleSubscriberListener::SetOwner(CarlaEgoVehicleControlSubscriber* owner) {
        _impl->_owner = owner;
    }

    CarlaVehicleSubscriberListener::CarlaVehicleSubscriberListener(CarlaEgoVehicleControlSubscriber* owner) :
    _impl(std::make_unique<CarlaVehicleSubscriberListenerImpl>()) {
        _impl->_owner = owner;
    }

    CarlaVehicleSubscriberListener::~CarlaVehicleSubscriberListener() {}
